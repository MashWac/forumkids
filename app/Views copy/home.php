...
<body>
    <div class="navbar">
        <img class="logo" src="/assets/images/imgs/logo.png" height="130px" width="130px">
        <ul class="topnav">
            <li><input class="searc" type="search" placeholder="Search.."></li>
        ...
        <ul class="botnav">
            ...
            <li><a href="Forumhome">FORUM</a></li>
...
<footer>
    ...
    <div class="last">
        <div class="socials"> 
            <h2>FOLLOW US:</h2>
            <h3><img src="/assets/images/imgs/tiktok.png" width="50px" height="50px"><a href="">TikTok</a></h3>
            <h3><img src="/assets/images/imgs/instagram.png" width="50px" height="50px"><a href="">Instagram</a></h3>
            <h3><img src="/assets/images/imgs/youtube.png" width="50px" height="50px"><a href="">Youtube</a></h3>
        </div>
        <div class="conts">
            <h2> CONTACT US:</h2>
            <h3><a href="mailto:info@joysunbear.com">info@joysunbear.com</a></h3>
        </div>
        <div class="news">
            <h2>Newsletter:</h2>
            <h3>Subscribe to our newsletter</h3>
            <input type="text" placeholder="Email" name="email" class="searc">
        </div>
    </div>
</footer>
</body>

...
<body>
    ...
    <div class="one">
        ...
        <form action="/registration/child"  method="post" autocomplete="off">
            <label for="name">Name</label><br>
            <input type="text" size="30" id="name" name="kidname" title="Enter your name"><br></br>

            <label for="age">Age</label><br>
            <input type="text" size="30" id="age" name="age" title="Enter your Age"><br></br>

           

            <label for="gender">Gender</label><br>
            <select class="combo" name="gender">
                <option value="Male">Male</option>
                <option value="Female">Female</option>
            </select>
            <br></br>
            <label for="parentsemail">Parent Email</label>
            <input type="email" id="email" name="parentemail" size="30" maxlength="60" required placeholder="username@gmail.com"  title="provide only an address with 'gmail.com'"><br>

            <label for="email">Email</label>
            <input type="email" id="email" name="email" size="30" maxlength="60" required placeholder="username@gmail.com"  title="provide only an email address with 'gmail.com'"><br></br>
